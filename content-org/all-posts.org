...
***** SWAP test
      ...
      \end{align}$$
      $$\begin{align}
      e_s &= s \langle S_2 \vert U_2 \vert S_1 \rangle \langle S_1 \vert U_1 \vert S_2\rangle + \left( s \langle S_2 \vert U_2 \vert S_1 \rangle \langle S_1 \vert U_1 \vert S_2\rangle \right)^*\\
      &= 2 \times \Re \left( s \langle S_2 \vert U_2 \vert S_1 \rangle \langle S_1 \vert U_1 \vert S_2\rangle \right)
      \end{align}$$
