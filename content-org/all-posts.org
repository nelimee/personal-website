...
*** A first test-case
    ...
    This test-case turned out to be a very good *test*-case as it exhibited a caveat I did not think
    ...
    $\vert 1 \rangle$? It turned out that the first test-case I tried raised this issue.
    ...
    which means that the algorithm fails.
